    ...
    <nav class="mt-4 px-2 space-y-4 flex-grow" aria-label="Main navigation">
      ...
      <template v-for="(item, index) in navItems" :key="`nav-item-${index}`">
        ...
        <div v-if="isAdmin && item.route === 'admin.colleges.index'" class="py-2">
          ...
          <!-- Members & Officers link after Plan of Activities -->
          <div class="mt-4">
            <NavigationItem 
              :item="{
                name: 'Members & Officers',
        ...
        <div v-if="!isAdmin && item.route === 'student-orgs.index'" class="py-2">
          ...
          <!-- Plan of Activities link after New Application for users -->
          <div class="mt-4">
            <NavigationItem 
              :item="{
                name: 'Plan of Activities',
          ...
          <!-- Members & Officers link after Plan of Activities for users -->
          <div class="mt-4">
            <NavigationItem 
              :item="{
                name: 'Members & Officers',
          ...
          <!-- Calendar link after Members & Officers for regular users -->
          <div class="mt-4">
            <NavigationItem 
              :item="{
                name: 'Calendar',
