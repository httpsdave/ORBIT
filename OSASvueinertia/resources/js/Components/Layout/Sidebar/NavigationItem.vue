...
<template>
  ...
  >
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" :class="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'h-6 w-6' : 'h-5 w-5'" :fill="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'currentColor' : 'none'" :viewBox="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? '0 -960 960 960' : '0 0 24 24'" :stroke="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'none' : 'currentColor'" :style="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'color: inherit; opacity: 1;' : ''">
        <path :stroke-linecap="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'none' : 'round'" :stroke-linejoin="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? 'none' : 'round'" :stroke-width="(item.icon.includes('m160-419') || item.icon.includes('M640-400') || item.icon.includes('m80-520')) ? '0' : '2'" :d="item.icon" />
      </svg>
