...
<template>
  <div class="mt-6 form-content">
    ...
    <div class="very-respectfully mt-12 mb-8">
      ...
      <div class="sig-row"><span class="sig-label">Home Address:</span><span class="sig-line" :style="form.adviser_address.length > 50 ? 'display:block;min-width:170px;word-break:break-word;white-space:pre-line;' : ''">
    {{ form.adviser_address }}
  </span></div>
<div v-if="form.adviser_address.length > 50" class="sig-row">
  <span class="sig-label"></span>
  <span class="sig-line" style="min-width:170px;word-break:break-word;white-space:pre-line;">
    {{ form.adviser_address.substring(50) }}
  </span>
</div>
