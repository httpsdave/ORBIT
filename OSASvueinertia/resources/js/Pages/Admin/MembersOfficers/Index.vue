...
const endIndex = computed(() => Math.min(startIndex.value + itemsPerPage, currentData.value.length));
const currentPageData = computed(() => {
  return currentData.value.slice(startIndex.value, endIndex.value);
});
  ...
  <SidebarLayout :is-admin="isAdmin">
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-8">
        ...
        <div class="mb-8">
          ...
          <div class="max-w-4xl mx-auto px-3 sm:px-6 mb-6 space-y-3">
            ...
            <div class="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2">
              ...
              <div v-if="activeTab === 'members'" class="col-span-1">
                <select 
            ...
            <div v-if="hasActiveFilters" class="flex flex-wrap gap-1.5 sm:gap-2 items-center text-xs sm:text-sm">
              ...
              <span v-if="semesterFilter !== 'all'" class="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-md text-xs">
          ...
          <div class="max-w-4xl mx-auto px-3 sm:px-6 mb-6">
            <div class="text-sm text-gray-600 dark:text-gray-400 text-center">
              Showing <span class="font-semibold text-blue-600 dark:text-blue-400">{{ startIndex + 1 }}-{{ endIndex }}</span> of <span class="font-semibold text-blue-600 dark:text-blue-400">{{ currentData.length }}</span> {{ activeTab === 'members' ? 'members' : 'officers' }}
        ...
        <!-- Members Table -->
        <div v-if="activeTab === 'members'" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <!-- Officers Table -->
        <div v-if="activeTab === 'officers'" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                <tr>
