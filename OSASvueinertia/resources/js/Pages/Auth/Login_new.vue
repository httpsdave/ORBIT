...
<template>
    ...
    <!-- Full screen container with inverted split layout -->
    <div class="min-h-screen flex relative overflow-hidden">
        ...
        <!-- Gradient indicator - Bottom left -->
        <div class="absolute bottom-6 left-6 w-4 h-4 rounded-full transition-all duration-1000 ease-in-out z-30" 
