              ...
              <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                  ...
                  <div v-if="activeTab === 'applications'">
                    <Link :href="route('applications.index')" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                ...
                <div v-if="activeTab === 'applications'">
                  <div v-if="props.myApplications && props.myApplications.length > 0" class="space-y-3">
                    <div v-for="application in props.myApplications.slice(0, 3)" :key="application.id" 
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <Link :href="`/applications`" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 bg-blue-50 dark:bg-blue-900/50 hover:bg-blue-100 dark:hover:bg-blue-900/70 p-2 rounded-full transition-colors duration-200">
                  ...
                  <div v-else class="text-center py-12 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <Link :href="route('applications.create')" class="mt-3 inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
              ...
              <div class="p-6">
                ...
                <div v-if="props.upcomingEvents && props.upcomingEvents.length > 0" class="space-y-4">
                  ...
                  <div class="text-center pt-4" v-if="props.upcomingEvents.length > 3">
                    <Link :href="route('calendar')" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                ...
                <div v-else-if="!props.todayEvent" class="text-center py-12 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <Link :href="route('calendar')" class="inline-block mt-3 px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                    View Calendar
                  </Link>
                </div>
              </div>
