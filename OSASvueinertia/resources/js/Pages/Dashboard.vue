...
<template>
    ...
    <AuthenticatedLayout>
      ...
      <div class="py-8">
          ...
          <!-- Welcome Card - Styled like admin greeting card -->
          <div 
          ...
          >
            <div class="p-6 bg-white border-b border-gray-200">
              ...
              <!-- Stats Section - Using consistent styling with admin stats cards -->
            ...
            >
              <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                  ...
                  <Link :href="route('applications.create')" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
