    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12 bg-gray-50">
            <div class="mx-auto max-w-7xl space-y-8 sm:px-6 lg:px-8">
                ...
                <div class="bg-white p-6 shadow-md rounded-lg border-l-4 border-blue-500 transition-all duration-300 hover:shadow-xl">
                    <div class="mb-4">
                ...
                <div class="bg-white p-6 shadow-md rounded-lg border-l-4 border-green-500 transition-all duration-300 hover:shadow-xl">
                    <div class="mb-4">
                        <h3 class="text-lg font-medium text-gray-900 flex items-center">
