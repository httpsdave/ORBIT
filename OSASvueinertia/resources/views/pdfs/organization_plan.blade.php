...
<body>
    ...
    <div class="noted" style="text-align:left; margin-top:5px;">
        ...
        <div class="signature-container clearfix">
            <div class="signature-left">
                <div class="signature-line" style="margin-bottom:0px;"><strong>{!! $application->adviser_name ?: '&nbsp;' !!}</strong></div>
        ...
        <!-- Third signature row with Dean -->
            <div class="signature-container clearfix" style="margin-top:5px;">
                <div class="signature-left">
                    <div class="signature-line" style="margin-bottom:0px; white-space:nowrap; min-width:180px; display:inline-block;"><strong>{!! $application->dean_name ?: '&nbsp;' !!}</strong></div>
