                                    ...
                                    <td class="info-cell">
                                        <div class="member-info underline">
                                            @if($leftMember && $leftMember->student_name && $leftMember->student_name !== 'Sample Data')
                                                @php
                                                    if (strlen($leftMember->student_name) > 40) {
                                                        $studentNameFontSize = '6pt';
                                                    } elseif (strlen($leftMember->student_name) > 35) {
                                                        $studentNameFontSize = '7pt';
                                                    } elseif (strlen($leftMember->student_name) > 32) {
                                    ...
                                    <td class="info-cell">
                                        <div class="member-info underline">
                                                @if($rightMember && $rightMember->student_name && $rightMember->student_name !== 'Sample Data')
                                                    @php
                                                        if (strlen($rightMember->student_name) > 40) {
                                                            $studentNameFontSize = '6pt';
                                                        } elseif (strlen($rightMember->student_name) > 35) {
                                                            $studentNameFontSize = '7pt';
                                                        } elseif (strlen($rightMember->student_name) > 32) {
                                                            $studentNameFontSize = '8pt';
    ...
    <table class="signature-table" style="width: 100%; margin-top: -10px; border-collapse: collapse;">
                    ...
                    <div style="width: 200px; margin: 0 auto; margin-left: 35px;">
                        <p style="margin-bottom: 0;">
                            @php
                                ...
                                $fontSize = strlen($fullAdviserName) > 30 ? '9pt' : (strlen($fullAdviserName) > 20 ? '10pt' : '12pt');
                            @endphp
                            <span class="date-signature-line" style="display: inline-block; min-width: 200px; width: auto; text-align: center; font-size: 11pt; white-space: nowrap;"><strong>{{ $fullAdviserName }}</strong></span>
                        </p>
                    ...
                    <div style="width: 200px; margin: 0 auto; margin-left: 110px;">
                        <p style="margin-bottom: 0;">
                            @php
                                ...
                                $secondAdviserFontSize = strlen($fullSecondAdviserName) > 30 ? '9pt' : (strlen($fullSecondAdviserName) > 20 ? '10pt' : '12pt');
                            @endphp
                                <span class="date-signature-line" style="display: inline-block; min-width: 200px; width: auto; text-align: center; font-size: 11pt; white-space: nowrap;"><strong>{!! $fullSecondAdviserName ?: '&nbsp;' !!}</strong></span>
                        </p>
                        <p style="margin-top: 2px; text-align: center;">Organization Adviser</p>
                    </div>
        ...
        <div class="dean-signature center-align" style="width: 50% !important; margin-top: 3px; text-align: center !important;">
            ...
            @php
                ...
                $deanFontSize = strlen($fullDeanName) > 30 ? '9pt' : (strlen($fullDeanName) > 20 ? '10pt' : '12pt');
            @endphp
            <p style="margin-bottom: 0; text-align: center !important; margin-top: 5px;"><span class="date-signature-line" style="display: inline-block; min-width: 180px; width: auto; font-size: 11pt; white-space: nowrap;"><strong>{!! $fullDeanName ?: '&nbsp;' !!}</strong></span></p>
        ...
        @if($totalMembers > 0)
                        ...
                        <div style="width: 200px; margin: 0 auto; margin-left: 10px;">
                            <p style="margin-bottom: 0;">
                                @php
                                    ...
                                    $fontSize2 = strlen($fullAdviserName2) > 30 ? '9pt' : (strlen($fullAdviserName2) > 20 ? '10pt' : '12pt');
                                @endphp
                                <span class="date-signature-line" style="display: inline-block; min-width: 200px; width: auto; text-align: center; font-size: 11pt; white-space: nowrap;"><strong>{{ $fullAdviserName2 }}</strong></span>
                            </p>
                        ...
                        <div style="width: 200px; margin: 0 auto; margin-left: 110px;">
                            <p style="margin-bottom: 0;">
                                @php
                                    ...
                                    $secondAdviserFontSize2 = strlen($fullSecondAdviserName2) > 30 ? '9pt' : (strlen($fullSecondAdviserName2) > 20 ? '10pt' : '12pt');
                                @endphp
                                    <span class="date-signature-line" style="display: inline-block; min-width: 200px; width: auto; text-align: center; font-size: 11pt; white-space: nowrap;"><strong>{!! $fullSecondAdviserName2 ?: '&nbsp;' !!}</strong></span>
                            </p>
                            <p style="margin-top: 2px; text-align: center; font-weight: normal;">Organization Adviser</p>
                        </div>
                        <p style="text-align: left; padding-left: 110px; margin-top: -10px;">Date: <span class="date-signature-line"><strong>{{ now()->format('F d, Y') }}</strong></span></p>
            ...
            <div class="dean-signature center-align" style="width: 50% !important; margin-top: 3px; text-align: center !important;">
                ...
                @php
                    ...
                    $deanFontSize2 = strlen($fullDeanName2) > 30 ? '9pt' : (strlen($fullDeanName2) > 20 ? '10pt' : '12pt');
                @endphp
                <p style="margin-bottom: 0; text-align: center !important; margin-top: 5px;"><span class="date-signature-line" style="display: inline-block; min-width: 180px; width: auto; font-size: 11pt; white-space: nowrap;"><strong>{!! $fullDeanName2 ?: '&nbsp;' !!}</strong></span></p>
                <p style="margin-top: 3px; font-weight: normal; margin-left: 0 !important; text-align: center !important;">Dean/Assoc. Dean of College</p>
            </div>
