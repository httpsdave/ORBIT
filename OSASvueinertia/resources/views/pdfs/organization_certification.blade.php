...
<body>
    @foreach($studentCertifications as $index => $certification)
        ...
        <div class="certification-page">
            ...
            </div> from the College of <span class="signature-line" style="min-width:385px; border-bottom: 1px solid black; display: inline-block;">{{ $application->college ?? 'Sample Data' }}</span> is a bonafide LSPU Student, not
            <br><br>
            </div>
