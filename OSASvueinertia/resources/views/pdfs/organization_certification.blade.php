    ...
    @foreach($studentCertifications as $index => $certification)
        ...
        <div class="certification-page">
            ...
            <div style="display: inline-block; vertical-align: bottom; position: relative; top: 6px;">
                <div>
                    <span class="student-blank" style="min-width: 390px; border-bottom: 1px solid black; text-align: center; font-weight: bold; font-size: {{ strlen($certification->student_name ?? '') > 30 ? '10pt' : '11pt' }}; word-wrap: break-word; overflow-wrap: break-word;">{{ $certification->student_name ?? '' }}</span>
                </div>
            ...
            <div style="margin-top: -55px;">
                <span class="signature-line" style="width:230px; max-width:230px; border-bottom: 1px solid black; display: inline-block; font-weight: bold; font-size: {{ strlen($certification->position_rank ?? '') > 20 ? '10pt' : '11pt' }}; word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.2; text-align: center;">{{ $certification->position_rank ?? ' ' }}</span> of the <span class="signature-line" style="min-width:315px; max-width:315px; border-bottom: 1px solid black; display: inline-block; font-weight: bold; font-size: {{ strlen($application->organization_name ?? '') > 40 ? '10pt' : '11pt' }}; word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.2;">{{ $application->organization_name ?? 'Sample Data' }}</span>.
                <br>
        ...
        <div class="signature-section" style="margin-top: 100px;">
            ...
            <div style="margin-top: -65px; text-align: center;">
                <div class="signature-name" style="min-width: 415px; margin-bottom: 0px; font-weight: bold; font-size: {{ strlen($application->director_name ?? '') > 30 ? '10pt' : '11pt' }}; word-wrap: break-word; overflow-wrap: break-word;">{{ strtoupper($application->director_name ?? 'Sample Data') }}</div>
